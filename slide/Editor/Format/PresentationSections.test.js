...
var units = {A: "Einfuehrung"};
ok(sections.canRenameSection(made, units) === true, "a section the user added may be renamed");
ok(sections.canRenameSection(add.Sections[0], units) === false, "a unit's section may not");
ok(sections.canRenameSection(made) === true, "with no unit map, anything named may be");
